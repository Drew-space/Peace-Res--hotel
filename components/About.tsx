          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-end">
            ...
            >
              ...
              <motion.p
                ...
                className="text-[#666] text-sm sm:text-[15px] leading-[1.6] max-w-lg"
              >
                Since 2016, we&apos;ve been quietly curating spaces where
                travelers actually want to stay — not just sleep. Our team is
                small, obsessive, and based across three time zones.
              </motion.p>
            </motion.div>
          </div>
        </div>
